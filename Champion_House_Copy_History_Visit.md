# Page Copy Draft — History & Visit/Contact

Ready to drop into the Astro build. Voice matches the Home/Donate draft: warm but restrained, historically grounded, no overselling. Bracketed items `[like this]` are placeholders needing a decision before launch.
...
**Hero image:** `Henry_Champion_House.jpg` (archival photo — note the rooftop balustrade, since removed) or a lead photo from `72001323.pdf` (1972 National Register nomination photos)
...
### Colonel Henry Champion — Feeding an Army
...
### General Henry Champion — A Life at the House
...
> The house's Federal-period details are well documented in its 1972 National Register nomination: a gambrel roof with a long rear slope nearly reaching a lean-to, twin brick chimneys, an Ionic-columned and triangular-pedimented entry portico, matching pedimented dormers, and twelve-over-twelve sash windows throughout the main house. A one-and-a-half-story ell extends to the south, later fitted with a conservatory. A historic stone wall with iron gates still marks the property's edge along the road.
>
> [Optional caption for `Henry_Champion_House.jpg`]: A rooftop balustrade, visible in this earlier photograph, was removed sometime between 1966 and 1972.

**Images:** 1972 NR nomination photos from `72001323.pdf` (front, north side, south side/conservatory), `Henry_Champion_House.jpg` as a "how the house has changed" caption pairing.
...
> The Champion House holds two federal historic designations. It was added to the National and State Registers of Historic Places on October 10, 1972 (NR reference #72001323). It's also a stop on the Washington–Rochambeau Revolutionary Route, a National Park Service–designated National Historic Trail retracing the march of the Continental and French armies in 1781 and 1782.

**Decided (2026-08-03):** plain paragraph text, no badge/icon treatment for the two designations.
...
> Much of this history comes from the Colchester Historical Society's own research on the Champion family, along with the original 1972 National Register nomination. For more, visit the [Colchester Historical Society](https://www.colchesterhistory.org/museum/exhibits/the-story-of-the-champion-family/).
...
**Subhead:**
The house is privately owned and under active restoration — here's how to reach us.

**Hero image:** `image6.jpeg` (driveway/approach shot) works well as a "how to find us" visual.
...
> 526 Westchester Rd, Colchester, CT 06415
...
> The house is currently undergoing restoration and is not open for public visits or tours at this time. As work progresses, we hope to welcome visitors — check back here, or reach out below, for updates.
...
> Have a question, a document, or an old photograph of the house? We'd love to hear from you.

**Form fields:** Name, Email, Message

**Direct contact (optional, alongside form):**
> charlespjordan@icloud.com
> (917) 460-2260
